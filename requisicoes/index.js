...
GerenciadorDeRequisicao.prototype.gerenciarEdicaoFormulario = function(request,response){
	this.controleDeFormulario.gerenciarEdicaoFormulario(request,response);
}
